...
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('16', '6', 'KFV-FRESH-3L', 'Fresh Whole Farm Milk (3 Liters)', 'Pure wholesome unhomogenized fresh farm milk rich in nutrients and natural cream, bottled daily in a 3L container.', '/images/download_45.jpg', '3 Liters', '9000.00', '6000.00', '100', '5', '1', '2026-08-30 20:40:35', '2026-08-30 20:47:52');
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('17', '6', 'KFV-YOGURT-1L', 'Kitonga Farm Artisanal Yogurt (1 Liter)', 'Smooth, velvety artisanal drinking yogurt cultured from fresh morning milk, available in luscious Vanilla and ripe Strawberry infusions in a 1L bottle.', '/images/yogurt_1l.jpg', '1 Liter', '6000.00', '3800.00', '80', '5', '1', '2026-08-30 20:40:35', '2026-08-30 20:47:52');
...
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('19', '7', 'KFV-ASALI-1KG', 'Raw Wild Forest Honey (1kg Net Weight)', '100% pure, unfiltered and unheated golden raw honey harvested from traditional highland top-bar apiaries deep in the Komkonga forest (1kg net weight).', '/images/raw_forest_honey.jpg', '1 kg', '10000.00', '6500.00', '100', '5', '1', '2026-08-30 20:40:36', '2026-08-30 20:47:52');
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('20', '6', 'KFV-MAYAI-KISASA', 'Farm Fresh Organic Eggs (Tray)', 'Farm-fresh organic eggs with vibrant golden yolks, gathered every morning from free-range pasture hens.', '/images/farm_egg_trays.jpg', 'Tray (30 Eggs)', '8000.00', '5500.00', '150', '5', '1', '2026-08-30 20:40:36', '2026-08-30 20:47:52');
