...
INSERT INTO `cms_sections` (`id`, `cms_page_id`, `key`, `type`, `value`, `metadata`, `created_at`, `updated_at`) VALUES ('4', '2', 'farm_story', 'text', 'Kitonga Farm Villas is built on a 150-acre organic reserve dedicated to agroecology. We cultivate modern horticulture, harvest raw honey, and raise dairy cows, all while maintaining absolute preservation of the native countryside flora and fauna.', NULL, '2026-08-26 21:12:14', '2026-08-26 21:12:14');
...
INSERT INTO `farm_tours` (`id`, `name`, `slug`, `description`, `price`, `capacity_per_slot`, `active`, `created_at`, `updated_at`, `category`, `duration`, `featured_image`, `gallery`, `video`, `inclusions`, `highlights`, `good_to_know`, `featured`, `sort_order`, `seo_title`, `seo_description`, `status`) VALUES ('2', 'General Farm Tour', 'general-farm-tour', 'Our complete agritourism experience. Dive deep into all operational aspects of Kitonga Farm: visit modern horticulture greenhouses, interact with dairy and poultry livestock, and taste farm-fresh organic items right from the soil.', '50000.00', '15', '1', '2026-08-26 21:12:10', '2026-08-26 21:12:10', 'Complete Ecosystem', '4 Hours', 'general_farm_hero.webp', '[\"general_farm_hero.webp\",\"three_cows.webp\",\"download_41.webp\",\"download_40.webp\"]', NULL, '[\"Complete farm tour covering all zones\",\"Greenhouses and modern horticulture admission\",\"Livestock interaction (cattle, goats, poultry)\",\"Mini-bar beverage & farm yogurt tasting\",\"Swimming pool access\"]', '[\"High-tech horticulture and vegetable greenhouses\",\"Interacting with dairy cows and poultry birds\",\"Local yogurt and milk tasting session\"]', 'Perfect for families and agricultural enthusiasts. Includes tasting items, but please advise us on any food allergies before arrival.', '1', '2', 'General Farm Tour - Immersive Experience', 'Detailed wider tour including livestock sections (dairy/cattle, goat farm, poultry houses: chicken, turkeys, ducks) plus modern horticulture greenhouses.', 'published');
...
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('4', '6', 'HARV-HONEY-01', 'Kitonga Farm Natural & Flavoured Yoghurt', 'Smooth, rich artisanal drinking yoghurt crafted from fresh morning milk, rich in natural probiotics and authentic farm sweetness.', 'IMG_0389.jpg', '500ml bottle', '3000.00', '12000.00', '25', '5', '0', '2026-08-26 21:12:12', '2026-08-29 21:32:18');
...
INSERT INTO `products` (`id`, `product_category_id`, `sku`, `name`, `description`, `image`, `unit`, `selling_price`, `cost_price`, `stock`, `low_stock_threshold`, `active`, `created_at`, `updated_at`) VALUES ('17', '6', 'KFV-YOGURT-1L', 'Kitonga Farm Artisanal Yogurt (1 Liter)', 'Smooth, velvety artisanal drinking yogurt cultured from fresh morning milk, rich in natural probiotics and authentic farm sweetness in a 1L bottle.', '/images/yogurt_1l.webp', '1 Liter', '6000.00', '3800.00', '80', '5', '1', '2026-08-30 20:40:35', '2026-08-30 20:47:52');
